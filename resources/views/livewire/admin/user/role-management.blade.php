<div class="p-6 bg-white rounded-lg shadow-md">
    <h2 class="text-2xl font-semibold mb-6">Gestion des rôles</h2>

    <!-- Create Role Form -->
    <div class="mb-8 p-4 bg-gray-50 rounded-md">
        <h3 class="text-lg font-medium mb-4">Créer un nouveau rôle</h3>
        ...
        @foreach($roles as $role)
            ...
            >
                ...
                <div class="text-sm text-gray-600">
                    {{ $role->permissions->count() }} Autorisations attribuées{{-- permissions assigned --}}
                </div>
            </div>
        @endforeach
    </div>
    ...
    @if($selectedRole)
        <div class="border rounded-md p-4">
            <h3 class="text-lg font-medium mb-4">{{-- Permissions for --}}Autorisations pour {{ $selectedRole->name }}</h3>
