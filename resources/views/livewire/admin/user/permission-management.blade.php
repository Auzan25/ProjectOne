<div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-700/30 transition-colors duration-300">
    <h2 class="text-2xl font-semibold mb-6 text-gray-800 dark:text-gray-100">Gestion des droits (autorisations)</h2>

    <!-- Create Permission Form -->
    <div class="mb-8 p-4 bg-gray-50 dark:bg-gray-700 rounded-md transition-colors duration-300">
        <h3 class="text-lg font-medium mb-4 text-gray-700 dark:text-gray-200"> Créer une nouvelle autorisation</h3>
        <form wire:submit.prevent="createPermission" class="space-y-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nom de l’autorisation</label>
                <input
                    type="text"
                    wire:model="name"
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Description (Facultatif)</label>
                <textarea
