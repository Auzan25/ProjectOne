<div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-700/30 transition-colors duration-300">
    <h2 class="text-2xl font-semibold mb-6 text-gray-800 dark:text-gray-100">Attribution des rôles utilisateur</h2>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Rôles actuels</th>
    ...
    @if($selectedUser)
        <div class="border dark:border-gray-600 rounded-md p-4 bg-white dark:bg-gray-800 transition-colors duration-300">
            <h3 class="text-lg font-medium mb-4 text-gray-800 dark:text-gray-100">Gérer les rôles pour {{ $selectedUser->name }}</h3>
